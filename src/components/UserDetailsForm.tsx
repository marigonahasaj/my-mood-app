            ...
            <div className="relative z-10 max-w-md w-full mx-auto space-y-6 flex flex-col justify-between flex-1">
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Sleep */}
                        <div>
                            <label className="block text-sm font-medium text-zinc-700 mb-2">Got any sleep this past week?</label>
                            {buttonGroup(
                                [
                        ...
                        {/* Social connection */}
                        <div>
                            <label className="block text-sm font-medium text-zinc-700 mb-2">Lately, have you felt more…</label>
                            {buttonGroup(
                                [
                        ...
                        {/* Mental clarity */}
                        <div>
                            <label className="block text-sm font-medium text-zinc-700 mb-2">How’s your mind feeling?</label>
                            {buttonGroup(
                                [
                        ...
                        {/* Dominant feeling */}
                        <div>
                            <label className="block text-sm font-medium text-zinc-700 mb-2">Which word describes you best right now?</label>
                            <input
                                type="text"
                        ...
                        {/* Emotional need */}
                        <div>
                            <label className="block text-sm font-medium text-zinc-700 mb-2">What do you feel you need most today?</label>
                            {buttonGroup(
                                [
