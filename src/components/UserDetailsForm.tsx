...
export function UserDetailsForm({
    ...
    return (
        <div className="w-full bg-white flex flex-col relative overflow-hiden mx-auto">
            <div
                className="relative z-10 max-w-md w-full mx-auto space-y-6 flex flex-col justify-between flex-1 p-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="mt-1 w-full border border-zinc-300 rounded-xl px-4 py-2 text-sm focus:ring-amber-200 text-zinc-600"
