...
export function UserDetailsForm({
    ...
    return (
        <div className="h-[650px] max-h-[650px] w-full bg-white flex flex-col relative overflow-hidden mx-auto">
            <div
                className="relative z-10 max-w-md w-full mx-auto space-y-6 flex flex-col justify-between flex-1 overflow-y-auto">
                <div className="space-y-6">
                    <h2 className="text-2xl font-semibold -tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-olive-500 via-olive-300 to-amber-400 w-full">
                    Okay but like… <span className="text-zinc-500">👀</span><br/> who even are you?
                    </h2>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="mt-1 w-full border border-zinc-300 rounded-xl px-4 py-2 text-sm text-zinc-600 focus:ring-amber-200"
    ...
    return (
        <div>
            ...
            <input
                ...
                className="mt-1 w-full border border-zinc-300 text-zinc-600 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-200"
            />
        </div>
    );
}
